...
// Verify this is a Non-Academic Admin
...
if (!$electionId) {
    header('Location: admin_analytics_nonacademic.php');
    exit();
}

// Fetch election details (only non-academic elections)
 $stmt = $pdo->prepare("SELECT * FROM elections WHERE election_id = ? AND target_position != 'student' AND target_position != 'faculty' AND target_position != 'coop'");
...
// ===== GET ELIGIBLE VOTERS COUNT =====
 $conditions = ["role = 'voter'", "position = ?"];
...
<div class="flex min-h-screen">
  ...
  <main class="flex-1 p-6 md:p-8 md:ml-64">
    <div class="max-w-7xl mx-auto">
      ...
      <!-- Back Button -->
      <div class="mt-6">
        <a href="admin_analytics_nonacademic.php" 

...
<head>
<meta charset="UTF-8" />
<title>Super Admin Verified</title>
<style>
  body {
    margin: 0;
...
<div class="modal">
  <div class="modal-content">
    ...
    <p>Your email has been successfully verified. You will be redirected to the super admin dashboard.</p>
    <button onclick="window.location.href='super_admin_dashboard.php'">Go to Dashboard</button>
  </div>
</div>

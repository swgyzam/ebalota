...
$assigned_scope = str_replace('_', ' ', $assigned_scope);

// Normalize scope values to match the format used in create_admin.php
$scopeMappings = [
    // College acronyms (should remain uppercase)
    'CAFENR' => 'CAFENR',
    'CEIT' => 'CEIT',
    'CAS' => 'CAS',
    'CVMBS' => 'CVMBS',
    ...
    // Other sectors (should be title case)
    ...
    // Special scopes (should remain as-is)
    'COOP' => 'COOP',
    'coop' => 'COOP',
    'CSG Admin' => 'CSG Admin',
    'csg admin' => 'CSG Admin',
...
// Apply normalization
$assigned_scope = $scopeMappings[$assigned_scope] ?? $assigned_scope;
